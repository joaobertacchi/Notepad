...
Voltando ao assunto, é validar o problema que se propõe a resolver e a solução proposta pela sua empresa é de suma importância para seu sucesso. Isto irá evitar que você gaste tempo e dinheiro com algo. O risco está em confundir manifestações de interesse em sua ideia ou MVP, mesmo que em grande volume, com fit de mercado. E isto é bastante tentador na fase inicial de uma startup, pois o que mais se quer é a confirmação das hipóteses sobre os clientes para iniciar o desenvolvimento e vendas.
