...
Voltando ao assunto, é de suma importância para seu sucesso que você valide o problema que se propõe a resolver e a solução proposta pela sua empresa. Isto irá evitar que você gaste tempo e dinheiro desenvolvendo algo que não tem mercado ou que não resolve o problema da forma correta. Novamente isto parece bem óbvio. Mas as dificuldades começam com o modo que será usado para fazer esta validação. O risco está em confundir manifestações de interesse em sua ideia ou MVP, mesmo que em grande volume, com fit de mercado. E isto é bastante tentador na fase inicial de uma startup, pois o que mais se quer é a confirmação das hipóteses sobre os clientes para iniciar o desenvolvimento e vendas.
